...
sample_populations_all_groups <- identified_pop_perc(sample_populations, all_gated)
...
```{r}
# I would ideally add in both of these functions to the add_perc_for_plot function, but I need the phenotype data one later...

# change the population rownames to column 
phenotype_data <- phenotype_data %>%
  rownames_to_column(var = "population")

sample_populations_all_groups <- identified_pop_perc(df1 = phenotype_data, df2 = all_gated)
...
CFUs <- read_xlsx("../Cyto-feature_engineering/data/M.smeg_CFU.xlsx") %>%
...
manual_gating_pop3 <- read_xlsx("../Cyto-feature_engineering/data/flow/BCG_v_PBS/manual_gating_pop3.xlsx") %>%
