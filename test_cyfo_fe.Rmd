...
fcsFiles <- list.files("../Cyto-feature_engineering/data/flow/BCG_v_PBS/Tcell/", 
...
D90_ws <- list.files("../Cyto-feature_engineering/data/flow/BCG_v_PBS", 
                     pattern = "AmyGating_intracellular_D90.csv", full = TRUE)

D90_initial_gate <- gatingTemplate(D90_ws, autostart = 1L) 

D90_fcsFiles <- list.files("../Cyto-feature_engineering/data/flow/BCG_v_PBS/Tcell/D90", 
                       pattern = ".fcs", full = TRUE)
...
unique(FMO_gated_data_clean$filename)

testing <- FMO_gated_data_clean %>%
...
right_quantile <- full_join(right, add_quantile, by = "filename")
unique(right_quantile$filename)
