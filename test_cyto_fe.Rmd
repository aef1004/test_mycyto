...
This is where I will make changes, and I can then compare the results with the original_cyto_fe
...
sample_populations_all_groups <- identified_pop_perc(sample_populations, all_gated, marker_vector = order_of_markers)
...
# add_perc <- left_join(phenotype_data, all_gated, by = order_of_markers)
# 
...
sample_populations_all_groups <- identified_pop_perc(df1 = phenotype_data, df2 = all_gated, marker_vector = order_of_markers)
...
calc_CFU_regression(facets_for_CFUs, "BH")
...
```{r}
plot_one_pop(facets_for_CFUs, facets_for_timeseries, "Pop32")
```
